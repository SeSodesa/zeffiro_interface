...
set(zef.h_exp_em_multires_sparsity ,'string',num2str(zef.exp_multires_sparsity));
...
set(zef.h_exp_em_multires_snr ,'string',num2str(zef.inv_snr));
set(zef.h_exp_em_multires_n_iter ,'string',num2str(zef.exp_multires_n_iter));
set(zef.h_exp_em_multires_n_L1_iterations ,'string',num2str(zef.inv_n_L1_iterations));
set(zef.h_exp_em_multires_sampling_frequency ,'string',num2str(zef.inv_sampling_frequency));
set(zef.h_exp_em_multires_low_cut_frequency ,'string',num2str(zef.inv_low_cut_frequency));
set(zef.h_exp_em_multires_high_cut_frequency ,'string',num2str(zef.inv_high_cut_frequency));
set(zef.h_exp_em_multires_data_segment ,'string',num2str(zef.inv_data_segment));
set(zef.h_exp_em_multires_normalize_data ,'value',zef.normalize_data);
set(zef.h_exp_em_multires_time_1 ,'string',num2str(zef.inv_time_1));
set(zef.h_exp_em_multires_time_2 ,'string',num2str(zef.inv_time_2));
set(zef.h_exp_em_multires_time_3 ,'string',num2str(zef.inv_time_3));
set(zef.h_exp_em_multires_number_of_frames ,'string',num2str(zef.number_of_frames));
