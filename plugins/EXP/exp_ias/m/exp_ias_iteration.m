...
q = evalin('base','zef.exp_ias_q');
beta = evalin('base','zef.exp_ias_beta');
...
reconstruction_information.tag = 'EXP IAS';
...
reconstruction_information.exp_ias_q = q;
...
reconstruction_information.exp_ias_theta0 = theta0;
reconstruction_information.exp_ias_beta = beta;
end
...
reconstruction_information.exp_ias_theta0 = gather(theta0);
reconstruction_information.exp_ias_beta = gather(beta);
end
