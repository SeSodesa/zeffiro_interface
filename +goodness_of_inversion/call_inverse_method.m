...
% successfully.
    ...
    if inverse_method_name == "MNE" ...
    || inverse_method_name == "sLORETA" ...
    || inverse_method_name == "dSPM"
        ...
        [rec, ~] = goodness_of_inversion.mne( ...
            ...
            "inv_amplitude_db", invp.inv_amplitude_db, ...
            "inv_prior_over_measurement_db", invp.inv_prior_over_measurement_db ...
        );
    ...
    if strcmp(inverse_method_name, "Beamformer")
        ...
        [rec, ~, ~] = goodness_of_inversion.beamformer( ...
            zef, ...
            "estimate_type", beamformer.beamformer_estimate_type, ...
            "estimated_attribute", beamformer.beamformer_estimated_attribute, ...
            "covariance_regularization_parameter", beamformer.beamformer_covariance_regularization_parameter, ...
            "covariance_mode", beamformer.beamformer_covariance_mode, ...
            "lead_field_regularization_parameter", beamformer.beamformer_lead_field_regularization_parameter, ...
            "lead_field_regularization_procedure", beamformer.beamformer_lead_field_regularization_procedure, ...
            "signal_to_noise_ratio", beamformer.beamformer_signal_to_noise_ratio, ...
            "sampling_frequency", beamformer.beamformer_sampling_frequency, ...
            "low_cut_frequency", beamformer.beamformer_low_cut_frequency, ...
            "high_cut_frequency", beamformer.beamformer_high_cut_frequency, ...
            "time_start", beamformer.beamformer_time_start, ...
            "time_window", beamformer.beamformer_time_window, ...
            "n_of_time_steps", beamformer.beamformer_n_of_time_steps, ...
            "time_step", beamformer.beamformer_time_step, ...
            "data_segment", beamformer.beamformer_data_segment, ...
            "data_normalization", beamformer.beamformer_data_normalization, ...
            "lead_field_normalization", beamformer.beamformer_lead_field_normalization, ...
            "inv_cov_lambda", beamformer.beamformer_inv_cov_lambda, ...
            "inv_lead_field_lambda", beamformer.beamformer_inv_lead_field_lambda ...
        );
    ...
    if strcmp(inverse_method_name, "RAMUS")
        ...
        [rec, ~] = goodness_of_inversion.ramus( ...
            zef, ...
            "multiresolution_levels", ramus.ramus_multiresolution_levels, ...
            "multiresolution_sparsity", ramus.ramus_multiresolution_sparsity, ...
            "n_of_decompositions", ramus.ramus_n_of_decompositions, ...
            "hyperprior", ramus.ramus_hyperprior, ...
            "signal_to_noise_ratio", ramus.ramus_signal_to_noise_ratio, ...
            "ias_map_iterations", ramus.ramus_ias_map_iterations, ...
            "sampling_frequency", ramus.ramus_sampling_frequency, ...
            "low_cut_frequency", ramus.ramus_low_cut_frequency, ...
            "high_cut_frequency", ramus.ramus_high_cut_frequency, ...
            "time_start", ramus.ramus_time_start, ...
            "time_window", ramus.ramus_time_window, ...
            "n_of_time_steps", ramus.ramus_n_of_time_steps, ...
            "time_step", ramus.ramus_time_step, ...
            "data_normalization", ramus.ramus_data_normalization, ...
            "initial_guess_mode", ramus.ramus_initial_guess_mode, ...
            "n_decompositions", ramus.ramus_n_decompositions, ...
            "n_levels", ramus.ramus_n_levels, ...
            "multires_sparsity", ramus.ramus_multires_sparsity ...
        );
