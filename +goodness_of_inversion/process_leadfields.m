function [L, n_interp, procFile] = process_leadfields(source_direction_mode)

    % process_leadfields
    %
    % Processes the leadfield in zef and applies all visibility options. L is
    % the leadfield, the procFile has all information needed for the
