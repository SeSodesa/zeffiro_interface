    ...
    if evalin('base','zef.use_gpu') == 1 && gpuDeviceCount > 0
        ...
        for i = 1 : n_of_electrodes
            ...
            ,                                                                                               ...
                wb                                                                                          ...
            ,                                                                                               ...
                ['PCG iteration. Ready: ' datestr(datevec(now+(n_of_electrodes/i - 1)*time_val/86400)) '.'] ...
            );
        ...
        for i = 1 : block_size : n_of_electrodes
            ...
            x_block_cell = cell(0);
            relres_cell = cell(0);
            x_block = zeros(n_of_fem_nodes,length(block_ind));
            ...
            % Substitute matrices. TODO: replace with a call to a given
            % subsitution function, that returns the matrices T and
            % Schur_complement, modified as necessary.
            ...
            ,                                                                                                       ...
                wb                                                                                                  ...
            ,                                                                                                       ...
                ['PCG iteration. Ready: ' datestr(datevec(now+(n_of_electrodes/(i+length(block_ind)-1) - 1)*time_val/86400)) '.'] ...
            );
