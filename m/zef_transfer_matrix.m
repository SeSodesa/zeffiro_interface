function [T, Schur_complement, A] = zef_transfer_matrix(A, B, C, N, L, electrode_model, permutation, precond, impedance_vec, impedance_inf, tol_val, m_max)

% zef_transfer_matrix: builds a transfer matrix T and an auxiliary matrix
% Schur_complement from a given stiffness matrix A, electrode matrices B and
% C, sizes N and L, a permutation matrix and a precoditioner, through
