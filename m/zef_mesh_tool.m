...
set(zef.h_save_forward_simulation_profile,'ButtonPushedFcn','zef.forward_simulation_table = zef.h_forward_simulation_table.Data; writecell(zef.forward_simulation_table, zef.program_path + filesep + "profile" + filesep +  zef.profile_name + "zeffiro_forward_simulation.ini",''filetype'',''text'',''delimiter'','','');');
...
set(zef.h_forward_simulation_update_from_profile,'ButtonPushedFcn','zef.forward_simulation_table = readcell(zef.program_path + filesep + "profile" + filesep +  zef.profile_name + filesep + "zeffiro_forward_simulation.ini",''filetype'',''text'',''delimiter'','','');zef.h_forward_simulation_table.Data = zef.forward_simulation_table;');
