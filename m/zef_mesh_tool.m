...
set(zef.h_save_forward_simulation_profile,'ButtonPushedFcn','zef.forward_simulation_table = zef.h_forward_simulation_table.Data; writecell(zef.forward_simulation_table, fullfile(zef.program_path, "profile", zef.profile_name, "zeffiro_forward_simulation.ini"),''filetype'',''text'',''delimiter'','','');');
...
set(zef.h_forward_simulation_update_from_profile,'ButtonPushedFcn','zef.forward_simulation_table = readcell(fullfile(zef.program_path, "profile", zef.profile_name, "zeffiro_forward_simulation.ini"),''filetype'',''text'',''delimiter'','','');zef.h_forward_simulation_table.Data = zef.forward_simulation_table;');
...
zef.forward_simulation_table = readcell(fullfile(zef.program_path, "profile", zef.profile_name, "zeffiro_forward_simulation.ini"),'filetype','tex','delimiter',',');
end
