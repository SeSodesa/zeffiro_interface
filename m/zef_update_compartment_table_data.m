...
for zef_k =  1 : size(zef.parameter_profile,1)
  ...
  zef.aux_field_1{zef_i,zef_n+zef.compartment_table_size} = num2str(evalin('base',['zef.' zef.compartment_tags{zef_i} '_' zef.parameter_profile{zef_k,2}]));
  elseif isequal(zef.parameter_profile{zef_k,3},'String')
  zef.aux_field_1{zef_i,zef_n + zef.compartment_table_size} = (evalin('base',['zef.' zef.compartment_tags{zef_i} '_' zef.parameter_profile{zef_k,2} ]));
  end
  end
end
