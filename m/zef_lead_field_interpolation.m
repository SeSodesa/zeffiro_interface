function L = zef_lead_field_interpolation( ...
    ...
    if ~ nargin == narguments
        error(strcat("I need ", num2str(narguments), " arguments. Returning empty interpolated lead field..."));
    end

    % Open up a waitbar

    wbtitle = 'Lead field interpolation';
    ...
    if p_source_model == ZefSourceModel.Hdiv
    ...
    if p_source_model == ZefSourceModel.Whitney
