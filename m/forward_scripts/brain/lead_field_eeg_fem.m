...
for i = 1 : 4
    ...
    grad_1 = 1/2 * cross(                  ...
        nodes(tetrahedra(:,ind_m(i,2)),:)' ...
        -                                  ...
        nodes(tetrahedra(:,ind_m(i,1)),:)' ...
        ,                                  ...
        nodes(tetrahedra(:,ind_m(i,3)),:)' ...
        -                                  ...
        nodes(tetrahedra(:,ind_m(i,1)),:)' ...
    );

    grad_1 = grad_1 .* repmat(                      ...
        sign(                                       ...
            dot(                                    ...
                grad_1,(nodes(tetrahedra(:,i),:)'   ...
                -                                   ...
                nodes(tetrahedra(:,ind_m(i,1)),:)') ...
            )                                       ...
        ),                                          ...
    ...
    for j = i : 4
        ...
        if i == j
            ...
            grad_2 = 1/2 * cross(                      ...
                    nodes(tetrahedra(:,ind_m(j,2)),:)' ...
                    -                                  ...
                    nodes(tetrahedra(:,ind_m(j,1)),:)' ...
                ,                                      ...
                    nodes(tetrahedra(:,ind_m(j,3)),:)' ...
                    -                                  ...
                    nodes(tetrahedra(:,ind_m(j,1)),:)' ...
            );

            grad_2 = grad_2 .* repmat(                  ...
                sign( dot(                              ...
                    grad_2,(nodes(tetrahedra(:,j),:)'   ...
                    -                                   ...
                    nodes(tetrahedra(:,ind_m(j,1)),:)') ...
                )),                                     ...
                3, 1                                    ...
