...
[zef.nearest_neighbour_inds, zef.source_ind] = decomposition_and_source_index_fn( ...
    zef.nodes, ...
    zef.tetra, ...
    zef.brain_activity_inds, ...
    zef.source_model, ...
...
zef.source_tetra_inds = zef.brain_activity_inds(zef.source_ind);
zef.n_sources_mod = 0;
...
if zef.lead_field_type == 1
    ...
    if evalin('base','zef.prism_layers') && not(isempty(zef.prisms))
        [zef.L, zef.source_positions, zef.source_directions] = lead_field_eeg_fem( ...
            zef.nodes_aux, ...
            {zef.tetra,zef.prisms}, ...
            {zef.sigma(:,1), zef.sigma_prisms}, ...
            zef.sensors_aux, ...
            zef.nearest_neighbour_inds, ...
            zef.brain_activity_inds, ...
            zef.source_tetra_inds, ...
            zef.lf_param ...
        );
    else
        [zef.L, zef.source_positions, zef.source_directions] = lead_field_eeg_fem( ...
...
if zef.lead_field_type == 4
    ...
    if evalin('base','zef.prism_layers') && not(isempty(zef.prisms))
        [zef.L, zef.inv_bg_data, zef.source_positions, zef.source_directions, zef.eit_ind, zef.eit_count] = lead_field_eit_fem( ...
            zef.nodes_aux, ...
            {zef.tetra,zef.prisms}, ...
            {zef.sigma(:,1),zef.sigma_prisms}, ...
            zef.sensors_aux, ...
...
if zef.lead_field_type == 5
    ...
    if evalin('base','zef.prism_layers') && not(isempty(zef.prisms))
        [zef.L, zef.S, zef.source_positions, zef.source_directions, zef.eit_ind, zef.eit_count] = lead_field_tes_fem( ...
            zef.nodes_aux, ...
            {zef.tetra,zef.prisms}, ...
            {zef.sigma(:,1),zef.sigma_prisms}, ...
            zef.sensors_aux, ...
...
function [nearest_neighbour_inds, source_inds] = decomposition_and_source_index_fn( ...
    nodes, ...
    tetra, ...
    ...
    [nearest_neighbour_inds, ~, ~, source_inds] = zef_decompose_dof_space( ...
        nodes, ...
        tetra, ...
        restricted_brain_inds, ...
        [], ...
